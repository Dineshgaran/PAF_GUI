...
$(document).on("click",".btnUpdate",function(event)
		{
			$("#hidPostIDSave").val($(this).data("postID"));
			$("#postTitle").val($(this).closest("tr").find('td:eq(0)').text());
			$("#content").val($(this).closest("tr").find('td:eq(1)').text());
			$("#publishedDate").val($(this).closest("tr").find('td:eq(2)').text());
			$("#publishedTime").val($(this).closest("tr").find('td:eq(3)').text());
